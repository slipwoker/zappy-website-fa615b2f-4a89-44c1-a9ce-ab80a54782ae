            ...
            fields.forEach(function(field) {
                if (!validateField(field)) {
                    ...
                    if (!existingError) {
                        ...
                        errorMsg.textContent = field.getAttribute('data-error') || 
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMsg.textContent = contactForm.getAttribute('data-success') || 'Message sent successfully!';
                ...
                .catch(function() {
                    ...
                    errorMsg.textContent = contactForm.getAttribute('data-error') || 'Something went wrong. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fa615b2f-4a89-44c1-a9ce-ab80a54782ae',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fa615b2f-4a89-44c1-a9ce-ab80a54782ae';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fa615b2f-4a89-44c1-a9ce-ab80a54782ae';
